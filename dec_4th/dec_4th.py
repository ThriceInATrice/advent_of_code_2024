...
def get_descending_diagonals(char_matrix):
    """this function returns a list of the characters along each diagonal line in the orginal character matrix
    descending refers to the fact that the lines start in the top left and descend to the bottom right"""
    diagonals = []
...
def get_ascending_diagonals(char_matrix):
    """this function returns a list of the characters along each diagonal line in the orginal character matrix
    ascending refers to the fact that the lines start in the bottom left and descend to the top right"""
    diagonals = []
